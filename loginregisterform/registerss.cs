...
namespace loginregisterform
{
    ...
    public class registerss : Activity
    {
        ...
        private void UIReferences()
        {
            ...
            google = FindViewById<ImageView>(Resource.Id.imageeviewgoogle);
            name = FindViewById<EditText>(Resource.Id.editextnameuser);
            email = FindViewById<EditText>(Resource.Id.edittextemailaddress);
            user = FindViewById<EditText>(Resource.Id.edittextusernames);
